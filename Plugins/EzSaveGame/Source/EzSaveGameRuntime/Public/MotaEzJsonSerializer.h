...
#include "MotaEzJsonSerializer.generated.h"

/**
 * JSON serializer using Unreal's built-in Json module.
 */
UCLASS()
class EZSAVEGAMERUNTIME_API UMotaEzJsonSerializer : public UObject
{
    GENERATED_BODY()
